/* ── State ── */
const STATE={song:{title:'',artist:'',link:'',bpm:120,signature:'4/4',blocks:[],channels:[],progressions:[],library:{riffs:[]}},ui:{activeChannelId:null,view:'summary',rhythmTab:'blocks',tabTab:'blocks',isPlaying:false,currentBlockIndex:0,currentBeat:0,autoScroll:true,metronomeTimer:null,countIn:1,isCountingIn:false,countInBeatsLeft:0,blockProgress:0}};
